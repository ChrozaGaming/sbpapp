			...
			<div class="sidebar sidebar-twocol">
				<div class="sidebar-left slimscroll">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						...
						<a class="nav-link active" id="v-pills-sales-tab" title="Sales" data-bs-toggle="pill" href="#v-pills-sales" role="tab" aria-controls="v-pills-sales" aria-selected="false">
							<span class="material-icons-outlined">
								shopping_bag
							</span>
						</a>
				...
				<div class="page-header">
					<div class="row align-items-center">
						...
						<div class="col-auto float-end ms-auto">
							<a href="create_invoice.php" class="btn add-btn"><i class="fa-solid fa-plus"></i> Create Invoice</a>
						</div>
					</div>
				</div>
				<!-- /Page Header -->
								...
								<tbody>
									...
									if ($result->num_rows > 0) {
										...
										while ($row = $result->fetch_assoc()) {
											echo "<tr>";
											echo "<td>" . $row["id"] . "</td>";
											echo "<td><a href='invoice-view.html'>#INV-" . sprintf('%04d', $row["id"]) . "</a></td>";
											echo "<td>" . $row["client_name"] . "</td>";
											echo "<td>" . date('d M Y', strtotime($row["created_at"])) . "</td>";
											echo "<td>" . date('d M Y', strtotime($row["due_date"])) . "</td>";
											echo "<td>$" . $row["amount_due"] . "</td>";
											echo "<td><span class='badge bg-inverse-success'>" . ($row["is_paid"] ? "Paid" : "Unpaid") . "</span></td>";
